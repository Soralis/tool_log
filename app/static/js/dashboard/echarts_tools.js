...
ws = new WebSocket(`${protocol}//${window.location.host}/dashboard/ws/echart_tools`);
...
export function initializeComponents() {
    ...
    // Setup click handlers for graph cards to open modal (reuse existing function if defined)
    console.log('setupGraphCardClick.Handlers calling');
    setupGraphCardClickHandlers();

    console.log('setupGraphCardClick.Handlers finished');
