...
To run collective updates for the log devices, connect to the Server via SSH and run the following code (replace {running_deployment} with the actually running deployment app_blue or app_green)
```bash
